...
//     // Realizar la solicitud solo una vez (cuando el componente se monte) y cuando el ID cambie
//     fetchDogTemperaments();
//   }, [id]);

//   // Renderizar el componente con los temperamentos almacenados en el estado local
//   return (
//     <div className={styles.caja}>
//       <div className={styles.container}>
//         <Link to={`/detailBd/${id}`} className={styles.link}>
